...
class PipelineTuningOptions(ffi.ObjectRef):
    ...
    def speed_level(self, value):
        if not 0 <= value <= 3:
            raise ValueError("Optimization level for speed should be 0, 1, 2, or 3")
...
ffi.lib.LLVMPY_AddVerifierPass.argtypes = [
    ffi.LLVMModulePassManagerRef,
]
ffi.lib.LLVMPY_AddAAEvalPass_module.argtypes = [
    ffi.LLVMModulePassManagerRef,
]
...
ffi.lib.LLVMPY_PTOSetLoopUnrolling.argtypes = [ffi.LLVMPipelineTuningOptionsRef, c_bool]
