...
if sys.version_info >= (3, 13):
    ...
    class ContextManager(
        AbstractContextManager[_T_co, bool | None], Protocol[_T_co]
    ): ...

    @runtime_checkable
    class AsyncContextManager(
        AbstractAsyncContextManager[_T_co, bool | None], Protocol[_T_co]
    ): ...
...
class Coroutine(
    Awaitable[_ReturnT_co_nd], Generic[_YieldT_co, _SendT_contra_nd, _ReturnT_co_nd]
):
    __name__: str
    __qualname__: str
...
class _TypedDict(Mapping[str, object], metaclass=ABCMeta):
    ...
    if sys.version_info >= (3, 9):
        @overload
        def __or__(
            self, value: typing_extensions.Self, /
