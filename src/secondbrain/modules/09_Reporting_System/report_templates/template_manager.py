...
class TemplateManager:
    ...
    def create_config(self, config: TemplateConfig) -> bool:
        ...
        try:
            ...
            logger.error(
                f"Failed to create template configuration {config.name}: {str(e)}"
            )
            return False
...
if __name__ == "__main__":
    ...
    config = TemplateConfig(
        ...
        sections=[
            {"name": "header", "type": "text", "content": "User Report"},
            {
                "name": "user_info",
                "type": "table",
                "fields": ["username", "email", "created_at"],
            },
            {"name": "activity_summary", "type": "chart", "chart_type": "bar"},
        ],
        styles={
            "header": {"font_size": "24px", "color": "#333"},
            "table": {"border": "1px solid #ddd", "padding": "8px"},
        },
    ...
    data = {
        ...
        "activity": {"logins": 10, "notes": 5, "tasks": 3},
    }
