...
class IntegrationTester:
    ...
    def create_config(self, config: IntegrationConfig) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to create integration test configuration {config.name}: {str(e)}")
            return False
    ...
    def update_config(self, name: str, config: IntegrationConfig) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to update integration test configuration {name}: {str(e)}")
            return False
    ...
    def delete_config(self, name: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to delete integration test configuration {name}: {str(e)}")
            return False
        ...
        try:
            ...
            for dependency in config.dependencies:
                if not self._check_dependency(dependency):
                    ...
                    return {"success": False, "error": f"Dependency {dependency} not satisfied"}
            ...
            logger.error(f"Failed to run integration tests for configuration {config_name}: {str(e)}")
    ...
    def _run_scenario(self, scenario: Dict[str, Any], config: IntegrationConfig) -> Dict[str, Any]:
        """Run a test scenario.
    ...
    def add_scenario(self, config_name: str, scenario: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to add test scenario to configuration {config_name}: {str(e)}")
            return False
    ...
    def remove_scenario(self, config_name: str, scenario_name: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to remove test scenario from configuration {config_name}: {str(e)}")
            return False
