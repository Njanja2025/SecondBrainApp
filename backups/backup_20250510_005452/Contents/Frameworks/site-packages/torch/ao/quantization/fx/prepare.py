...
def _maybe_insert_input_observer_for_arg_or_kwarg(
    ...
    if not is_standalone_module:
        ...
        arg_as_input_target_dtype, arg_as_input_target_is_dynamic = (
        ...
        arg_as_output_target_dtype, arg_as_output_target_is_dynamic = (
        ...
        for maybe_obs_node in arg.users.keys():
            if maybe_obs_node.op == "call_module":
                ...
                if (
                    ...
                    and maybe_obs_mod.dtype == arg_as_input_target_dtype
                ):
