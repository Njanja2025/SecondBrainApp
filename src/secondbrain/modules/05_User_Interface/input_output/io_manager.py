...
class IOManager:
    ...
    def process_input(
        self, config_name: str, input_data: Union[str, bytes]
    ) -> Optional[Any]:
        """Process user input.
    ...
    def _process_voice_input(
        self, input_data: bytes, config: IOConfig
    ) -> Optional[str]:
        """Process voice input.
    ...
    def format_output(
        self, config_name: str, output_data: Any
    ...
    def _format_voice_output(
        self, output_data: Any, config: IOConfig
    ) -> Optional[bytes]:
        """Format voice output.
