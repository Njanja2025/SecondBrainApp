...
class CompanionJournalingBackup:
                ...
                if log_file.is_file():
                    with open(log_file) as f:
                        ...
                        for entry in logs:
                            ...
                            entry_types[emotion_type] = entry_types.get(emotion_type, 0) + 1
                ...
                if pattern_file.is_file():
                    with open(pattern_file) as f:
                        ...
                        for entry in patterns:
                            ...
                            entry_types[pattern_type] = entry_types.get(pattern_type, 0) + 1
    ...
    def _create_backup_manifest(
        ...
        manifest = {
            ...
            "total_entries": sum(
                stats.total_entries for stats in [
                    journal_stats,
                    emotional_stats,
                    memory_stats,
                    pattern_stats
