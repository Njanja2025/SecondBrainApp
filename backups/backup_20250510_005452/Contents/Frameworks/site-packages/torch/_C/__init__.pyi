...
def _construct_storage_from_data_pointer(
    data_ptr: _int, device: torch.device, size: _int
) -> Storage: ...
def _should_allow_numbers_as_tensors(func_name: str) -> _bool: ...
def _group_tensors_by_device_and_dtype(
    nested_tensorlists: List[List[Optional[Tensor]]], with_indices: _bool = False
) -> Dict[
    Tuple[torch.device, str], Tuple[List[List[Optional[Tensor]]], List[_int]]
]: ...
...
def _log_api_usage_metadata(
    event: str, metadata_map: Dict[str, str]
...
class Tag(Enum):
    ...
    generated: _int = 3
    inplace_view: _int = 4
    nondeterministic_bitwise: _int = 5
    nondeterministic_seeded: _int = 6
    pointwise: _int = 7
    pt2_compliant_tag: _int = 8
    view_copy: _int = 9
...
def _pop_torch_dispatch_stack(
    mode_key: Optional[torch._C._TorchDispatchModeKey] = None,
) -> Any: ...
...
def _dispatch_find_schema_or_throw(
    name: str, overload_name: str
) -> _DispatchOperatorHandle: ...
def _dispatch_set_report_error_callback(
    handle: _DispatchOperatorHandle, callback: Callable
) -> None: ...
...
class TensorBase(metaclass=_TensorMeta):
    ...
    def __getitem__(
        ...
        indices: Union[
            Union[
                SupportsIndex,
                Union[None, _bool, _int, slice, ellipsis, Tensor],
                _NestedSequence[Union[None, _bool, _int, slice, ellipsis, Tensor]],
            ],
            tuple[
                Union[
                    SupportsIndex,
    ...
    @overload
    def __init__(
        self, size: _size, *, device: Optional[DeviceLikeType] = None
    ) -> None: ...
    ...
    def _sparse_mask_projection(
        self, mask: Tensor, accumulate_matches: _bool = False
    ) -> Tensor: ...
    def _to_dense(
        self, dtype: Optional[_dtype] = None, masked_grad: Optional[_bool] = None
    ) -> Tensor: ...
    @overload
    def _to_sparse(
        self,
    ...
    def addcdiv(
        self, tensor1: Tensor, tensor2: Tensor, *, value: Union[Number, _complex] = 1
    ) -> Tensor: ...
    def addcdiv_(
        self, tensor1: Tensor, tensor2: Tensor, *, value: Union[Number, _complex] = 1
    ) -> Tensor: ...
    ...
    @overload
    def divide(
        self, other: Union[Number, _complex], *, rounding_mode: Optional[str]
    ) -> Tensor: ...
    @overload
    ...
    def fill_diagonal_(
        self, fill_value: Union[Number, _complex], wrap: _bool = False
    ) -> Tensor: ...
    def fix(self) -> Tensor: ...
    ...
    @overload
    def flatten(
        self, start_dim: _int, end_dim: _int, out_dim: Union[str, ellipsis, None]
    ) -> Tensor: ...
    @overload
    def flatten(
        self,
    ...
    @overload
    def histogram(
        self, bins: Tensor, *, weight: Optional[Tensor] = None, density: _bool = False
    ...
    def pin_memory(
        self, device: Optional[Optional[DeviceLikeType]] = None
    ) -> Tensor: ...
    ...
    @overload
    def prod(
        self, dim: _int, keepdim: _bool = False, *, dtype: Optional[_dtype] = None
    ) -> Tensor: ...
    @overload
    def prod(
        self,
    ...
    @overload
    def random_(
        self, from_: _int, to: Optional[_int], *, generator: Optional[Generator] = None
    ) -> Tensor: ...
    @overload
    ...
    def renorm(
        self, p: Union[Number, _complex], dim: _int, maxnorm: Union[Number, _complex]
    ) -> Tensor: ...
    def renorm_(
        self, p: Union[Number, _complex], dim: _int, maxnorm: Union[Number, _complex]
    ) -> Tensor: ...
    ...
    @overload
    def scatter(
        self, dim: _int, index: Tensor, value: Union[Number, _complex], *, reduce: str
    ) -> Tensor: ...
    @overload
    def scatter(
    ...
    def set_(
        self,
        storage: Union[Storage, TypedStorage, UntypedStorage],
        offset: _int,
        size: _size,
        stride: _size,
    ) -> Tensor: ...
    ...
    @overload
    def sort(
        self, *, stable: Optional[_bool], dim: _int = -1, descending: _bool = False
    ...
    @overload
    def subtract(
        self, other: Tensor, *, alpha: Union[Number, _complex] = 1
    ) -> Tensor: ...
    @overload
    def subtract(
        self, other: Union[Number, _complex], alpha: Union[Number, _complex] = 1
    ) -> Tensor: ...
    @overload
    def subtract_(
        self, other: Tensor, *, alpha: Union[Number, _complex] = 1
...
def _cuda_beginAllocateCurrentStreamToPool(
    device: _int, mempool_id: Tuple[_int, _int]
) -> None: ...
def _cuda_endAllocateCurrentStreamToPool(device: _int) -> None: ...
def _cuda_releasePool(device: _int, mempool_id: Tuple[_int, _int]) -> None: ...
def _cuda_checkPoolLiveAllocations(
    device: _int, mempool_id: Tuple[_int, _int], expected_live_allocations: Set
) -> _bool: ...
...
def _cuda_record_memory_history(
    enabled: Optional[str], context: Optional[str], stacks: str, max_entries
) -> None: ...
...
def _cuda_getCheckpointState(
    device: _int, mempool: Tuple[_int, _int]
...
def _save_jit_module_to_bytes(
    m: ScriptModule, extra_files: Dict[str, Any]
) -> bytes: ...
