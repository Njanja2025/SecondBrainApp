...
from email_metrics import (
    EmailMetricsManager, MetricType, MetricCategory,
    EmailMetricConfig, MonitorConfig
)
from inbox_monitor import (
    InboxMonitor, FilterConfig, AlertConfig, MonitorConfig
)
...
class TestInboxMonitor:
    ...
    def test_create_config(self, temp_config_dir, sample_filter_config, sample_alert_config):
        """Test configuration creation."""
        monitor = InboxMonitor(str(temp_config_dir))
    ...
    def test_update_config(self, temp_config_dir, sample_filter_config, sample_alert_config):
        """Test configuration update."""
        monitor = InboxMonitor(str(temp_config_dir))
        config = MonitorConfig(
            name="gmail_monitor",
    ...
    def test_delete_config(self, temp_config_dir, sample_filter_config, sample_alert_config):
        """Test configuration deletion."""
        monitor = InboxMonitor(str(temp_config_dir))
        config = MonitorConfig(
            name="gmail_monitor",
    ...
    def test_get_config(self, temp_config_dir, sample_filter_config, sample_alert_config):
        """Test configuration retrieval."""
        monitor = InboxMonitor(str(temp_config_dir))
        config = MonitorConfig(
            name="gmail_monitor",
    ...
    def test_list_configs(self, temp_config_dir, sample_filter_config, sample_alert_config):
        """Test configuration listing."""
        monitor = InboxMonitor(str(temp_config_dir))
        config = MonitorConfig(
            name="gmail_monitor",
    ...
    @patch('imaplib.IMAP4_SSL')
    def test_apply_filters(self, mock_imap, temp_config_dir, sample_filter_config, sample_alert_config):
    ...
    @patch('imaplib.IMAP4_SSL')
    def test_check_alerts(self, mock_imap, temp_config_dir, sample_filter_config, sample_alert_config):
        """Test alert checking."""
        # Mock IMAP responses
        mock_imap.return_value.search.return_value = (None, [b'1 2 3'])
        mock_imap.return_value.fetch.return_value = (None, [(None, b'')])
    ...
    @patch('imaplib.IMAP4_SSL')
    def test_start_stop_monitoring(self, mock_imap, temp_config_dir, sample_filter_config, sample_alert_config):
