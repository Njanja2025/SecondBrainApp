...
class NamedTupleAnalyzer:
    ...
    def build_namedtuple_typeinfo(
        ...
        def add_method(
            ...
            if is_classmethod or is_new:
                first = [
                    Argument(
                        Var("_cls"), TypeType.make_normalized(self_type), None, ARG_POS
                    )
                ]
            else:
        ...
        add_method(
            "__new__", ret=None, args=[make_init_arg(var) for var in vars], is_new=True
        )
    ...
    def check_namedtuple_field_name(
        self, field: str, seen_names: Container[str]
    ) -> str | None:
