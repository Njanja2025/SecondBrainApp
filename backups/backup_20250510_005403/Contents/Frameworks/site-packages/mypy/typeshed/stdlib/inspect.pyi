...
@overload
def getmembers(
    object: object, predicate: _GetMembersPredicateTypeGuard[_T]
) -> _GetMembersReturn[_T]: ...
@overload
def getmembers(
    object: object, predicate: _GetMembersPredicateTypeIs[_T]
) -> _GetMembersReturn[_T]: ...
@overload
def getmembers(
    object: object, predicate: _GetMembersPredicate | None = None
) -> _GetMembersReturn[Any]: ...
...
def isdatadescriptor(
    object: object,
) -> TypeIs[_SupportsSet[Any, Any] | _SupportsDelete[Any]]: ...
...
if sys.version_info >= (3, 10):
    ...
    def signature(
        obj: _IntrospectableCallable, *, follow_wrapped: bool = True
    ) -> Signature: ...
...
class Signature:
    ...
    if sys.version_info >= (3, 10):
        ...
        @classmethod
        def from_callable(
            cls, obj: _IntrospectableCallable, *, follow_wrapped: bool = True
        ) -> Self: ...
...
def walktree(
    classes: list[type],
    children: Mapping[type[Any], list[type]],
    parent: type[Any] | None,
) -> _ClassTreeItem: ...
...
def getcallargs(
    func: Callable[_P, Any], /, *args: _P.args, **kwds: _P.kwargs
) -> dict[str, Any]: ...
...
def unwrap(
    func: Callable[..., Any], *, stop: Callable[[Callable[..., Any]], Any] | None = None
) -> Any: ...
