...
rand_default = CallFunction(
    aten.rand.default, Ignored(), dtype=Ignored(), device=Ignored(), pin_memory=False
)
gt_Scalar = CallFunction(
    aten.gt.Scalar, rand_default, KeywordArg("dropout_p"), _users=2
)
permute_default = CallFunction(
    aten.permute.default, KeywordArg("key"), Ignored(), _users=2
)
bmm_default = CallFunction(
    aten.bmm.default, KeywordArg("query"), permute_default, _users=2
)
...
bmm_default_2 = CallFunction(
    aten.bmm.default, KeywordArg("tangents_1"), permute_default_1
)
convert_element_type_default = CallFunction(
    prims.convert_element_type.default, gt_Scalar, Ignored()
)
...
clone_default = CallFunction(
    aten.clone.default, mul_Tensor_3, memory_format=torch.contiguous_format
)
...
mul_Tensor_4 = CallFunction(aten.mul.Tensor, clone_default, alias_default_1, _users=2)
...
bmm_default_5 = CallFunction(
    aten.bmm.default, permute_default_5, KeywordArg("tangents_1")
)
_sfdp_pattern_13_training = MultiOutputPattern(
    [bmm_default_1, bmm_default_3, permute_default_4, bmm_default_5, None]
)
...
_sfdp_pattern_13_inference = CallFunction(
    aten.bmm.default, clone_default, KeywordArg("value")
)
...
convert_element_type_default = CallFunction(
    prims.convert_element_type.default, bmm_default, Ignored(), _users=2
)
amax_default = CallFunction(
    aten.amax.default, convert_element_type_default, Ignored(), True
)
...
convert_element_type_default_1 = CallFunction(
    prims.convert_element_type.default, div_Tensor, Ignored(), _users=2
)
...
convert_element_type_default_3 = CallFunction(
    prims.convert_element_type.default, clone_default, Ignored()
)
...
convert_element_type_default_4 = CallFunction(
    prims.convert_element_type.default, alias_default_1, Ignored(), _users=2
)
mul_Tensor_4 = CallFunction(
    aten.mul.Tensor,
...
sum_dim_IntList_1 = CallFunction(aten.sum.dim_IntList, mul_Tensor_4, Ignored(), True)
mul_Tensor_5 = CallFunction(
    aten.mul.Tensor, convert_element_type_default_4, sum_dim_IntList_1
)
sub_Tensor_1 = CallFunction(aten.sub.Tensor, mul_Tensor_4, mul_Tensor_5)
convert_element_type_default_5 = CallFunction(
    prims.convert_element_type.default, sub_Tensor_1, Ignored(), _users=2
)
permute_default_2 = CallFunction(aten.permute.default, permute_default, Ignored())
bmm_default_3 = CallFunction(
    aten.bmm.default, convert_element_type_default_5, permute_default_2
)
permute_default_3 = CallFunction(aten.permute.default, KeywordArg("query"), Ignored())
bmm_default_4 = CallFunction(
    aten.bmm.default, permute_default_3, convert_element_type_default_5
)
permute_default_4 = CallFunction(aten.permute.default, bmm_default_4, Ignored())
permute_default_5 = CallFunction(aten.permute.default, mul_Tensor_1, Ignored())
bmm_default_5 = CallFunction(
...
_sfdp_pattern_13_training_half = MultiOutputPattern(
    [bmm_default_1, bmm_default_3, permute_default_4, bmm_default_5, None]
)
...
div_Tensor = CallFunction(aten.div.Tensor, exp_default, sum_dim_IntList)
convert_element_type_default_1 = CallFunction(
    prims.convert_element_type.default, div_Tensor, Ignored()
)
clone_default = CallFunction(aten.clone.default, convert_element_type_default_1)
_sfdp_pattern_13_inference_half = CallFunction(
    aten.bmm.default, clone_default, KeywordArg("value")
)
