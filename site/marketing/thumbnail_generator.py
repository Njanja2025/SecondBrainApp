...
class ThumbnailGenerator:
    ...
    def create_gradient_overlay(self, size, colors, direction='vertical', style_config=None):
    ...
    def create_thumbnail(self, title="Welcome to Njanja AI Empire", subtitle="AI-Powered Business Solutions", style_config=None):
        ...
        try:
            ...
            if style_config.get('gradient', True):
                gradient_colors = style_config.get('gradient_colors', [
                    (0, 0, 0, 128),
                    (0, 0, 0, 64)
                ])
