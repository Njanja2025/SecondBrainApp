...
def process_watermark(
    input_path: str, output_path: str, size: tuple = (150, 150)
) -> str:
    """
    ...
    try:
        ...
        with Image.open(input_path) as img:
            ...
            img_resized.save(output_path, format="PNG", optimize=True, quality=95)
...
def main():
    ...
    try:
        ...
        processed_path = process_watermark(
            str(input_path), str(output_path), size=(150, 150)
        )
