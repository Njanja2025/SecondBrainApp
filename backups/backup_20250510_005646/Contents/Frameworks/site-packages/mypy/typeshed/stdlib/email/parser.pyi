...
from email.feedparser import (
    BytesFeedParser as BytesFeedParser,
...
class Parser(Generic[_MessageT]):
    @overload
    def __init__(
        self: Parser[Message[str, str]],
        _class: None = None,
        *,
        policy: Policy[Message[str, str]] = ...,
    ) -> None: ...
    @overload
    def __init__(
        self, _class: Callable[[], _MessageT], *, policy: Policy[_MessageT] = ...
    ) -> None: ...
...
class BytesParser(Generic[_MessageT]):
    ...
    @overload
    def __init__(
        self: BytesParser[Message[str, str]],
        _class: None = None,
        *,
        policy: Policy[Message[str, str]] = ...,
    ) -> None: ...
