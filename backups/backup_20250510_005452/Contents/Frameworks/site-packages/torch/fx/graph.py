...
def _parse_stack_trace(stack_trace: str):
    if stack_trace is None:
        return None
    ParsedStackTrace = collections.namedtuple(
        "ParsedStackTrace", ["file", "lineno", "code"]
    )
    ...
    def gen_fn_def(self, free_vars, maybe_return_annotation):
        ...
        if len(free_vars) > 0:  # pytree has placeholders in it
            ...
            has_args_kwargs_tuple = (
                ...
                and len(self.pytree_info.in_spec.children_specs) == 2
            ...
            if has_args_kwargs_tuple:
                count_args = len(
                    self.pytree_info.in_spec.children_specs[0].children_specs
                )
...
class Graph:
    ...
    def _python_code(
        self, root_module: str, namespace: _Namespace, *, verbose: bool = False
    ) -> PythonCode:
        return self._codegen._gen_python_code(
            self.nodes, root_module, namespace, verbose=verbose
        )
