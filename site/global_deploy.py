...
class GlobalDeployer:
    ...
    def load_config(self) -> Dict:
        ...
        return {
            ...
            "regions": {
                "africa": {"payment": "paystack", "currency": "ZAR", "price": 499.00},
                "global": {"payment": "stripe", "currency": "USD", "price": 29.99},
            },
            "backup_retention_days": 30,
            "monitoring": {
                "endpoints": ["https://njanja.net", "https://global.njanja.net"],
    ...
    def monitor_endpoints(self) -> List[Dict]:
        ...
        for endpoint in self.config["monitoring"]["endpoints"]:
            try:
                ...
                issues.append({"endpoint": endpoint, "status": None, "error": str(e)})
        return issues
