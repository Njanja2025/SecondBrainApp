...
class SecureComms:
    ...
    async def create_channel(self, 
                           name: str, 
                           handler: Optional[Callable[[Dict[str, Any]], Awaitable[None]]] = None) -> str:
    ...
    async def receive_message(self, channel_id: str, timeout: Optional[float] = None) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            if isinstance(message_data, dict) and message_data.get("encrypted"):
                decrypted_bytes = self.encryption.decrypt_symmetric(message_data["data"])
