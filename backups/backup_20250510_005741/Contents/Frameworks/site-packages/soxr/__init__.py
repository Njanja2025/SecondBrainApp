...
_DTYPE_UNMATCH_ERR_STR = (
    "Input should be a `np.ndarray` with matching dtype for ResampleStream({})."
)
...
def _resample_oneshot(
    x: np.ndarray, in_rate: float, out_rate: float, quality="HQ"
) -> np.ndarray:
    """
