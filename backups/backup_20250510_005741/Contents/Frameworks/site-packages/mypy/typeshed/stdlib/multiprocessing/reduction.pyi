...
class ForkingPickler(pickle.Pickler):
    ...
    def __init__(
        self, file: SupportsWrite[bytes], protocol: int | None = ...
    ) -> None: ...
    @classmethod
...
if sys.platform == "win32":
    def duplicate(
        ...
        *,
        source_process: int | None = None,
    ) -> int: ...
    def steal_handle(source_pid: int, handle: int) -> int: ...
    def send_handle(
        conn: connection.PipeConnection[DupHandle, Any],
        handle: int,
        destination_pid: int,
    ) -> None: ...
    ...
    class DupHandle:
        def __init__(
            self, handle: int, access: int, pid: int | None = None
        ) -> None: ...
        def detach(self) -> int: ...
