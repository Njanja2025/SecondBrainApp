...
async def main():
    ...
    try:
        ...
        memory.configure_cloud_backup("google_drive", {
        ...
        memory.configure_cloud_backup("aws", {
        ...
        memory.remember_mood(
            "excited",
            context={"source": "cloud_backup_test"}
        )
...
if __name__ == "__main__":
    ...
    if not env_file.exists():
        with open(env_file, "w") as f:
            f.write("""# Cloud Service Credentials
