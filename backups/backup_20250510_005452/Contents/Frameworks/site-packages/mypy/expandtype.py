...
class ExpandTypeVisitor(TrivialSyntheticTypeTranslator):
        ...
        if isinstance(repl, ParamSpecType):
            return repl.copy_modified(
                ...
                prefix=t.prefix.copy_modified(
                    arg_types=self.expand_types(t.prefix.arg_types)
                    + repl.prefix.arg_types,
    ...
    def visit_type_var_tuple(self, t: TypeVarTupleType) -> Type:
        ...
        if isinstance(repl, TypeVarTupleType):
            return repl
        elif isinstance(repl, ProperType) and isinstance(
            repl, (AnyType, UninhabitedType)
        ):
    ...
    def interpolate_args_for_unpack(
        ...
        if isinstance(var_arg_type, Instance):
            ...
            new_unpack = AnyType(
                TypeOfAny.from_error, line=var_arg.line, column=var_arg.column
            )
        ...
        if param_spec is not None:
            ...
            if isinstance(repl, Parameters):
                ...
                expanded = t.copy_modified(
                    ...
                    imprecise_arg_kinds=(
                        t.imprecise_arg_kinds or repl.imprecise_arg_kinds
                    ),
                ...
                return t.copy_modified(
                    ...
                    imprecise_arg_kinds=(
                        t.imprecise_arg_kinds or prefix.imprecise_arg_kinds
                    ),
                )
    ...
    def visit_typeddict_type(self, t: TypedDictType) -> Type:
        ...
        result = t.copy_modified(
            item_types=self.expand_types(t.items.values()), fallback=fallback
        )
