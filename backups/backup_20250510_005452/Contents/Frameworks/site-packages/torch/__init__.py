...
def use_deterministic_algorithms(
    mode: builtins.bool, *, warn_only: builtins.bool = False
) -> None:
...
def _check_with(
    error_type, cond: Union[builtins.bool, SymBool], message: Callable[[], str]
):  # noqa: F811
...
def _sparse_coo_tensor_unsafe(*args, **kwargs):
    ...
    warnings.warn(
        "torch._sparse_coo_tensor_unsafe is deprecated, "
