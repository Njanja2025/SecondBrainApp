...
def _export(
    ...
    *,
    ...
    fake_args, fake_kwargs, fake_params_buffers, dynamo_fake_mode = (
    ...
    with zipfile.ZipFile(f, "r") as zipf:
        ...
        if extra_files is not None:
            for filename in extra_files.keys():
                extra_files[filename] = zipf.read(f"extra_files/{filename}").decode(
                    "utf-8"
                )
...
def aot_compile(
    ...
    *,
    ...
    if constraints is not None:
        warnings.warn(
            "The constraints field is deprecated. " "Please use dynamic_shapes instead."
        )
