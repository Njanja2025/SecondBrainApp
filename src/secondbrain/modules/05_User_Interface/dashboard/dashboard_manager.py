...
class DashboardManager:
        ...
        try:
            ...
            if config_file.exists():
                with open(config_file, 'r') as f:
                    self.dashboards = {name: DashboardConfig(**config)
    ...
    def _save_dashboards(self):
        ...
        try:
            ...
            with open(config_file, 'w') as f:
                json.dump({name: vars(config) for name, config in self.dashboards.items()},
                         f, indent=2)
    ...
    def add_widget(self, dashboard_name: str, widget: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to add widget to dashboard {dashboard_name}: {str(e)}")
            return False
    ...
    def remove_widget(self, dashboard_name: str, widget_id: str) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to remove widget from dashboard {dashboard_name}: {str(e)}")
            return False
    ...
    def update_layout(self, dashboard_name: str, layout: Dict[str, Any]) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to update layout for dashboard {dashboard_name}: {str(e)}")
            return False
