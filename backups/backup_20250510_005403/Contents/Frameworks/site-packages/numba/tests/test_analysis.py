...
class TestBranchPrune(TestBranchPruneBase, SerialMixin):
    ...
    def test_redefinition_analysis_different_block_cannot_exec(self):
        ...
        self.assert_prune(
            impl,
            (types.Array(types.float64, 2, "C"), types.NoneType("none"), types.float64),
            [True, None],
            np.zeros((2, 3)),
            None,
            1.2,
        ...
        self.assert_prune(
            impl,
            (types.Array(types.float64, 2, "C"), types.float64, types.NoneType("none")),
            [None, None],
            np.zeros((2, 3)),
            1.2,
            None,
...
class TestBranchPrunePostSemanticConstRewrites(TestBranchPruneBase):
    ...
    def test_array_ndim_attr(self):
        ...
        self.assert_prune(
            impl, (types.Array(types.float64, 2, "C"),), [False, None], np.zeros((2, 3))
        )
        self.assert_prune(
            impl, (types.Array(types.float64, 1, "C"),), [True, "both"], np.zeros((2,))
        )
    ...
    def test_tuple_len(self):
        ...
        self.assert_prune(
            impl, (types.UniTuple(types.int64, 3),), [False, None], tuple([1, 2, 3])
        )
        self.assert_prune(
            impl, (types.UniTuple(types.int64, 2),), [True, "both"], tuple([1, 2])
        )
    ...
    def test_ndim_not_on_array(self):
        ...
        self.assert_prune(
            impl, (types.Array(types.float64, 2, "C"),), [False], np.zeros((2, 3))
        )
