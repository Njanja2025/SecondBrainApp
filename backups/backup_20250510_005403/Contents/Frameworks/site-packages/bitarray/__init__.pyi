...
class bitarray:
    ...
    def bytereverse(self, start: int = ..., stop: int = ...) -> None: ...
    def clear(self) -> None: ...
    ...
    def decode(self, code: Union[CodeDict, decodetree]) -> Iterator: ...
    def endian(self) -> str: ...
    ...
    def to01(self, group: int = ..., sep: str = ...) -> str: ...
    ...
    @overload
    def __getitem__(self, s: Union[slice, bitarray, Sequence]) -> bitarray: ...
    @overload
    def __setitem__(self, i: Union[int, slice, Sequence], o: int) -> None: ...
    @overload
    def __setitem__(self, s: Union[slice, bitarray, Sequence], o: bitarray) -> None: ...
    def __delitem__(self, i: Union[int, slice, bitarray, Sequence]) -> None: ...
...
def _sysinfo() -> tuple: ...
def _bitarray_reconstructor(
    cls: type, buffer: bytes, endian: str, padbits: int, readonly: int
) -> bitarray: ...
