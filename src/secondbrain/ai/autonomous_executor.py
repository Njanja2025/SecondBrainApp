...
class AutonomousExecutor:
    ...
    async def _process_command(self, command: str, profile: Dict[str, Any]) -> Dict[str, Any]:
        """
    ...
    def _generate_response(self, result: Dict[str, Any], profile: Dict[str, Any]) -> str:
        """
        ...
        try:
            ...
            templates = self.response_templates.get(
                profile["tone"], 
                self.response_templates["professional"]
            )
