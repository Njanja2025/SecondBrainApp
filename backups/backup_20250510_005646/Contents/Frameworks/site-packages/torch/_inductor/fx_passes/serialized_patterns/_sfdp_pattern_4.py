...
mul_Tensor = CallFunction(
    aten.mul.Tensor, view_default_2, KeywordArg("scale_factor"), _users=2
)
...
clone_default = CallFunction(
    aten.clone.default, mul_Tensor_4, memory_format=torch.contiguous_format
)
...
mul_Tensor_5 = CallFunction(aten.mul.Tensor, clone_default, alias_default_1, _users=2)
sum_dim_IntList_1 = CallFunction(aten.sum.dim_IntList, mul_Tensor_5, Ignored(), True)
mul_Tensor_6 = CallFunction(aten.mul.Tensor, alias_default_1, sum_dim_IntList_1)
...
convert_element_type_default = CallFunction(
    prims.convert_element_type.default, mul_Tensor, Ignored(), _users=2
)
...
mul_Tensor_7 = CallFunction(
    aten.mul.Tensor, convert_element_type_default_5, KeywordArg("scale_factor")
)
view_default_8 = CallFunction(aten.view.default, mul_Tensor_7, Ignored(), _users=2)
permute_default_2 = CallFunction(aten.permute.default, view_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_2)
...
bmm_default_5 = CallFunction(aten.bmm.default, permute_default_5, view_default_6)
view_default_11 = CallFunction(aten.view.default, bmm_default_5, Ignored())
_sfdp_pattern_4_training_half = MultiOutputPattern(
    [view_default_5, view_default_9, permute_default_4, view_default_11, None, None]
)
...
view_default_4 = CallFunction(aten.view.default, expand_default_3, Ignored())
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
_sfdp_pattern_4_inference_half = CallFunction(
