...
class SystemMonitor:
    ...
    def get_process_metrics(self) -> List[ProcessMetrics]:
        ...
        for proc in psutil.process_iter(['pid', 'name', 'cpu_percent', 'memory_percent', 'status', 'create_time']):
            try:
                process_list.append(ProcessMetrics(
                    pid=proc.info['pid'],
                    name=proc.info['name'],
    ...
    async def _handle_health_alert(self, health: Dict[str, bool], metrics: SystemMetrics):
    ...
    def _generate_alert_message(self, health: Dict[str, bool], metrics: SystemMetrics) -> str:
