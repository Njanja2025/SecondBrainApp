...
def create_placeholder_avatar(expression: str, color: tuple, size: tuple = (200, 200)):
    ...
    if expression == "calm":
        ...
        # Eyes
        draw.ellipse([(center[0] - 30, center[1] - 20), (center[0] - 10, center[1] - 10)], fill='black')
        draw.ellipse([(center[0] + 10, center[1] - 20), (center[0] + 30, center[1] - 10)], fill='black')
        ...
        # Eyes
        draw.ellipse([(center[0] - 35, center[1] - 25), (center[0] - 10, center[1] - 10)], fill='black')
        draw.ellipse([(center[0] + 10, center[1] - 25), (center[0] + 35, center[1] - 10)], fill='black')
        ...
        # Eyes
        draw.ellipse([(center[0] - 30, center[1] - 20), (center[0] - 15, center[1] - 10)], fill='black')
        draw.ellipse([(center[0] + 15, center[1] - 20), (center[0] + 30, center[1] - 10)], fill='black')
