...
class TaskPlugin:
    ...
    def register_commands(self, voice_assistant: Any) -> None:
        ...
        try:
            ...
            voice_assistant.register_command("list_tasks", self._handle_list_tasks_command)
            voice_assistant.register_command("complete_task", self._handle_complete_task_command)
            voice_assistant.register_command("delete_task", self._handle_delete_task_command)
            voice_assistant.register_command("update_task", self._handle_update_task_command)
            voice_assistant.register_command("search_tasks", self._handle_search_tasks_command)
        except Exception as e:
            logger.error(f"Failed to register commands: {e}")
    
    def _handle_add_task_command(self, title: str, description: str = "", priority: str = "medium", due_date: Optional[str] = None, tags: List[str] = None) -> str:
    ...
    def _handle_list_tasks_command(self, status: str = "pending", priority: Optional[str] = None) -> str:
