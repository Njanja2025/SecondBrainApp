...
class ThemeManager:
        ...
        try:
            ...
            if config_file.exists():
                with open(config_file, 'r') as f:
                    self.themes = {name: ThemeConfig(**config)
    ...
    def _save_themes(self):
        ...
        try:
            ...
            with open(config_file, 'w') as f:
                json.dump({name: vars(config) for name, config in self.themes.items()},
                         f, indent=2)
    ...
    def get_color(self, theme_name: str, color_name: str) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Failed to get color {color_name} from theme {theme_name}: {str(e)}")
            return None
    ...
    def get_font(self, theme_name: str, font_name: str) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Failed to get font {font_name} from theme {theme_name}: {str(e)}")
            return None
    ...
    def get_icon(self, theme_name: str, icon_name: str) -> Optional[str]:
        ...
        try:
            ...
            logger.error(f"Failed to get icon {icon_name} from theme {theme_name}: {str(e)}")
            return None
    ...
    def get_spacing(self, theme_name: str, spacing_name: str) -> Optional[int]:
        ...
        try:
            ...
            logger.error(f"Failed to get spacing {spacing_name} from theme {theme_name}: {str(e)}")
            return None
    
    def get_animation(self, theme_name: str, animation_name: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"Failed to get animation {animation_name} from theme {theme_name}: {str(e)}")
            return None
