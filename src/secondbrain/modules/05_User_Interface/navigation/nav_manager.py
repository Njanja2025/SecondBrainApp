...
class NavigationManager:
        ...
        try:
            ...
            if config_file.exists():
                with open(config_file, 'r') as f:
                    self.configs = {name: NavConfig(**config)
    ...
    def create_config(self, config: NavConfig) -> bool:
        ...
        try:
            ...
            logger.error(f"Failed to create navigation configuration {config.name}: {str(e)}")
            return False
    ...
    def navigate_to(self, config_name: str, route: str, params: Optional[Dict[str, Any]] = None) -> bool:
        """Navigate to a route.
