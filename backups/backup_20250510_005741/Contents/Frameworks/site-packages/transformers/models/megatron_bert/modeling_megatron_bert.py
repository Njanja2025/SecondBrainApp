...
class MegatronBertModel(MegatronBertPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(
        MEGATRON_BERT_INPUTS_DOCSTRING.format("batch_size, sequence_length")
    )
    @add_code_sample_docstrings(
...
class MegatronBertForPreTraining(MegatronBertPreTrainedModel):
    ...
    @replace_return_docstrings(
        output_type=MegatronBertForPreTrainingOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
        input_ids: Optional[torch.LongTensor] = None,
...
class MegatronBertForMultipleChoice(MegatronBertPreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(
        MEGATRON_BERT_INPUTS_DOCSTRING.format(
