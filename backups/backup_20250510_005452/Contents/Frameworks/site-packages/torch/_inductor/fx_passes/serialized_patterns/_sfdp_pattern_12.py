...
_sfdp_pattern_12_training = MultiOutputPattern(
    [
        view_default_5,
        permute_default_6,
        permute_default_9,
...
convert_element_type_default_3 = CallFunction(
    prims.convert_element_type.default, clone_default_3, Ignored()
)
...
view_default_11 = CallFunction(aten.view.default, bmm_default_5, Ignored())
permute_default_11 = CallFunction(aten.permute.default, view_default_11, Ignored())
_sfdp_pattern_12_training_half = MultiOutputPattern(
    [
        view_default_5,
        permute_default_6,
        permute_default_9,
...
view_default_4 = CallFunction(aten.view.default, clone_default_3, Ignored())
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
_sfdp_pattern_12_inference_half = CallFunction(
