...
class Errors:
    ...
    def file_messages(
        self, path: str, formatter: ErrorFormatter | None = None
    ) -> list[str]:
    ...
    for error_tuple in error_tuples:
        ...
        if severity == "note":
            ...
            if error is None:
                ...
                error = MypyError(
                    file_path, line, column, message, errorcode, severity="note"
                )
                errors.append(error)
                continue
            ...
            error = MypyError(
                file_path, line, column, message, errorcode, severity="error"
            )
            errors.append(error)
            error_location = (file_path, line, column)
