...
class ExceptionFormatter:
    ...
    def _format_exception(
        ...
        *,
        ...
        # exception message.
        no_indented_indexes = (
            i for i, p in enumerate(exception_only) if not p.startswith(" ")
        )
        ...
        if error_message_index is not None:
            ...
            if self._colorize:
                if ":" in error_message:
                    ...
                    exception_type = self._theme["exception_type"].format(
                        exception_type
                    )
                    exception_value = self._theme["exception_value"].format(
                        exception_value
                    )
