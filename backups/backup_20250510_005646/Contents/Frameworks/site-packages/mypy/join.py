            ...
            for ta, sa, type_var in zip(t_args, s_args, t.type.defn.type_vars):
                ...
                if isinstance(ta_proper, AnyType):
                    ...
                    # an argument to keep track of recursive checks.
                        ...
                        if (
                            isinstance(ta_proper, UninhabitedType)
                            and ta_proper.ambiguous
                        ):
                            new_type = sa
                        elif (
                            isinstance(sa_proper, UninhabitedType)
                            and sa_proper.ambiguous
                        ):
                            new_type = ta
...
def match_generic_callables(
    t: CallableType, s: CallableType
) -> tuple[CallableType, CallableType]:
