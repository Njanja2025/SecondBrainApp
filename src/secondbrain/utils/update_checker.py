...
class UpdateChecker:
    ...
    def __init__(self, current_version: str, update_url: str = "https://njanja.net/version.txt"):
...
if __name__ == "__main__":
    ...
    if update_available:
        ...
        if checker.download_update(latest_version, "updates"):
            ...
            # Verify update
            if checker.verify_update(latest_version, f"updates/update_{latest_version}.zip"):
