...
class RollbackManager:
    ...
    def __init__(self, backup_dir: str = "backups", config_dir: str = "config/deployment"):
        ...
        try:
            ...
            if info_file.exists():
                with open(info_file, 'r') as f:
                    self.backups = {version: BackupInfo(**data) for version, data in json.load(f).items()}
            else:
                self.backups = {}
    ...
    def _save_backup_info(self):
        ...
        try:
            ...
            with open(info_file, 'w') as f:
                json.dump({version: asdict(info) for version, info in self.backups.items()},
    ...
    def rollback(self, version: str) -> bool:
        ...
        try:
            ...
            rollback_path = self.backup_dir / f"rollback_{version}_{datetime.now().strftime('%Y%m%d_%H%M%S')}"
