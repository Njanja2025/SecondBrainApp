...
class _SupportsEncodeToPayload(Protocol):
    def encode(
        self, encoding: str, /
    ) -> _PayloadType | _MultipartPayloadType | _SupportsDecodeToPayload: ...

class _SupportsDecodeToPayload(Protocol):
    def decode(
        self, encoding: str, errors: str, /
    ) -> _PayloadType | _MultipartPayloadType: ...
...
class Message(Generic[_HeaderT, _HeaderParamT]):
    ...
    @overload  # multipart
    def get_payload(
        self, i: int, decode: Literal[False] = False
    ) -> _PayloadType | MaybeNone: ...
    @overload  # either
    def get_payload(
        self, i: None = None, decode: Literal[False] = False
    ) -> _PayloadType | _MultipartPayloadType | MaybeNone: ...
    @overload  # not multipart
    def get_payload(
        self, i: None = None, *, decode: Literal[True]
    ) -> _EncodedPayloadType | MaybeNone: ...
    @overload  # not multipart, IDEM but w/o kwarg
    def get_payload(
        self, i: None, decode: Literal[True]
    ) -> _EncodedPayloadType | MaybeNone: ...
    ...
    def set_payload(
        self,
        payload: _SupportsDecodeToPayload | _PayloadType | _MultipartPayloadType,
        charset: None = None,
    ) -> None: ...
    @overload
    def set_payload(
        self,
        payload: (
            _SupportsEncodeToPayload
            | _SupportsDecodeToPayload
            | _PayloadType
            | _MultipartPayloadType
        ),
        charset: Charset | str,
    ) -> None: ...
    ...
    def as_bytes(
        self, unixfrom: bool = False, policy: Policy[Any] | None = None
    ) -> bytes: ...
...
class MIMEPart(Message[_HeaderRegistryT, _HeaderRegistryParamT]):
    ...
    ) -> MIMEPart[_HeaderRegistryT] | None: ...
