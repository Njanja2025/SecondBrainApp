...
class AuditSystem:
    ...
    def _init_database(self):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            c.execute('CREATE INDEX IF NOT EXISTS idx_audit_timestamp ON audit_events(timestamp)')
            c.execute('CREATE INDEX IF NOT EXISTS idx_audit_user_id ON audit_events(user_id)')
    ...
    def _check_security_metrics(self):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            if failed_logins >= self.thresholds['failed_logins_per_hour']:
                self.create_security_alert(SecurityAlert(
