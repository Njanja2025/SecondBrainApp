...
class BlenderbotSmallEncoderLayer(nn.Module):
    def __init__(self, config: BlenderbotSmallConfig):
        ...
        self.self_attn = BLENDERBOT_SMALL_ATTENTION_CLASSES[
...
class BlenderbotSmallDecoderLayer(nn.Module):
    def __init__(self, config: BlenderbotSmallConfig):
        ...
        self.self_attn_layer_norm = nn.LayerNorm(self.embed_dim)
        self.encoder_attn = BLENDERBOT_SMALL_ATTENTION_CLASSES[
            config._attn_implementation
        ](
            self.embed_dim,
...
class BlenderbotSmallEncoder(BlenderbotSmallPreTrainedModel):
    ...
    def __init__(
        self, config: BlenderbotSmallConfig, embed_tokens: Optional[nn.Embedding] = None
    ):
