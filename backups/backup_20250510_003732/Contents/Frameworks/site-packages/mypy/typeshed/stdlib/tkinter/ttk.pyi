...
class Widget(tkinter.Widget):
    def __init__(
        self, master: tkinter.Misc | None, widgetname, kw: Incomplete | None = None
    ) -> None: ...
...
class Panedwindow(Widget, tkinter.PanedWindow):
    def __init__(
        ...
        *,
        ...
        orient: Literal[
            "vertical", "horizontal"
        ] = "vertical",  # can't be changed with configure()
        style: str = "",
        takefocus: tkinter._TakeFocusValue = "",
        width: int = 0,
    ) -> None: ...
...
class Treeview(Widget, tkinter.XView, tkinter.YView):
    ...
    @overload
    def column(
        self, column: str | int, option: Literal["width", "minwidth"]
    ) -> int: ...
    @overload
    def column(
        self, column: str | int, option: Literal["stretch"]
    ) -> bool: ...  # actually 0 or 1
    @overload
    def column(
        self, column: str | int, option: Literal["anchor"]
    ) -> _tkinter.Tcl_Obj: ...
    @overload
    ...
    @overload
    def heading(
        self, column: str | int, option: Literal["image"]
    ) -> tuple[str] | str: ...
    @overload
    def heading(
        self, column: str | int, option: Literal["anchor"]
    ...
    @overload
    def heading(
        self, column: str | int, option: None = None
    ) -> _TreeviewHeaderDict: ...
    @overload
    def heading(
        self,
    ...
    @overload
    def item(
        self, item: str | int, option: Literal["open"]
    ) -> bool: ...  # actually 0 or 1
    @overload
    def item(
    ...
    def next(
        self, item: str | int
    ) -> str: ...  # returning empty string means last item
    ...
    def tag_bind(
        ...
        callback: Callable[[tkinter.Event[Treeview]], object] | None = None,
    ) -> str: ...
    @overload
