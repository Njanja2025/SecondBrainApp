...
from config import (
    HEALTH_CHECK_SETTINGS, BASE_DIR, DASHBOARD_DIR,
    BACKUP_DIR, CONFIG_DIR, EXPORT_DIR
)
...
class HealthChecker:
    def __init__(self):
        ...
        self.cache_duration = timedelta(minutes=HEALTH_CHECK_SETTINGS['interval_minutes'])
