...
class WeatherPlugin:
    ...
    def register_commands(self, voice_assistant: Any) -> None:
        ...
        try:
            ...
            voice_assistant.register_command("temperature", self._handle_temperature_command)
            ...
            voice_assistant.register_command("visibility", self._handle_visibility_command)
        except Exception as e:
    ...
    def _get_forecast(self, location: str, days: int = 5) -> Optional[List[Dict[str, Any]]]:
