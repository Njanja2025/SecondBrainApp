...
class HelpFormatter:
    ...
    help_width: (
        int | MaybeNone
    )  # initialized as None and computed later as int when storing option strings
...
class Option:
    ...
    ) -> None: ...  # accepted attrs depend on the ATTRS attribute
    def _set_opt_strings(self, opts: Iterable[str]) -> None: ...
    def check_value(
        self, opt: str, value: str
    ) -> Any: ...  # return type cannot be known statically
    def convert_value(
        self, opt: str, value: str | tuple[str, ...] | None
    ) -> Any: ...  # return type cannot be known statically
...
class Values:
    ...
    def _update(
        self, dict: Mapping[str, object], mode: Literal["careful", "loose"]
    ) -> None: ...
    ...
    def read_file(
        self, filename: str, mode: Literal["careful", "loose"] = "careful"
    ) -> None: ...
    def read_module(
        self, modname: str, mode: Literal["careful", "loose"] = "careful"
    ) -> None: ...
...
class OptionParser(OptionContainer):
    ...
    def _process_args(
        self, largs: list[Incomplete], rargs: list[Incomplete], values: Values
    ) -> None: ...
