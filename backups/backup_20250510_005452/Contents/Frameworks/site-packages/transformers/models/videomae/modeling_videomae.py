...
class VideoMAEEmbeddings(nn.Module):
    ...
    def forward(self, pixel_values, bool_masked_pos):
        ...
        embeddings = embeddings + self.position_embeddings.detach().type_as(
            embeddings
        ).to(device=embeddings.device, copy=True)
...
class VideoMAEForPreTraining(VideoMAEPreTrainedModel):
    ...
    def forward(
        ...
        expanded_position_embeddings = expanded_position_embeddings.detach().to(
            device=pixel_values.device, copy=True
        )
