...
class TypeAliasStmt(Statement):
    ...
    def __init__(
        self, name: NameExpr, type_args: list[TypeParam], value: LambdaExpr
    ) -> None:
        super().__init__()
        self.name = name
        self.type_args = type_args
...
VARIANCE_NOT_READY: Final = (
    3  # Variance hasn't been inferred (using Python 3.12 syntax)
)
...
class TypeVarExpr(TypeVarLikeExpr):
    ...
    def __init__(
        ...
        super().__init__(
            name, fullname, upper_bound, default, variance, is_new_style, line=line
        )
        self.values = values
