...
class ModuleMapGenerator:
    ...
    def __init__(self, output_path: Optional[str] = None):
        ...
        """
        self.output_path = output_path or str(Path.home() / '.secondbrain' / 'visualizations' / 'module_map')
    ...
    def _init_modules(self):
        ...
        self.features = {
            'WealthMCP': [
                ModuleConfig('Digital Product Store', ModuleType.FEATURE, 'lightgreen', 'note'),
                ModuleConfig('Affiliate Mall', ModuleType.FEATURE, 'lightgreen', 'note'),
                ModuleConfig('Dropshipping Hub', ModuleType.FEATURE, 'lightgreen', 'note'),
                ModuleConfig('Faceless Content', ModuleType.FEATURE, 'lightgreen', 'note'),
                ModuleConfig('AI Content Services', ModuleType.FEATURE, 'lightgreen', 'note'),
                ModuleConfig('Book Publishing', ModuleType.FEATURE, 'lightgreen', 'note'),
                ModuleConfig('Email Funnel System', ModuleType.FEATURE, 'lightgreen', 'note'),
                ModuleConfig('Ad Agent System', ModuleType.FEATURE, 'lightgreen', 'note')
            ],
            'CompanionMCP': [
                ModuleConfig('Voice Journaling', ModuleType.FEATURE, 'lightyellow', 'note'),
                ModuleConfig('Samantha Voice Sync', ModuleType.FEATURE, 'lightyellow', 'note'),
                ModuleConfig('Academic & Sermon Writer', ModuleType.FEATURE, 'lightyellow', 'note'),
                ModuleConfig('Emotional Intelligence Layer', ModuleType.FEATURE, 'lightyellow', 'note')
            ],
            'EngineeringMCP': [
                ModuleConfig('Game Generation System', ModuleType.FEATURE, 'lightcoral', 'note'),
                ModuleConfig('Music Drafting + Video Integration', ModuleType.FEATURE, 'lightcoral', 'note'),
                ModuleConfig('AI Blueprint & Terminal Studio', ModuleType.FEATURE, 'lightcoral', 'note')
            ]
        }
