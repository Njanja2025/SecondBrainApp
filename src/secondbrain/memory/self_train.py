...
class SelfTrainingManager:
    ...
    def _backup_current_model(self):
        ...
        try:
            ...
            for file in model_files:
                backup_path = (
                    file.parent / f"{file.stem}{self.backup_suffix}{file.suffix}"
                )
    ...
    def _restore_from_backup(self):
        ...
        try:
            ...
            for backup in backup_files:
                original = (
                    backup.parent
                    / f"{backup.stem.replace(self.backup_suffix, '')}.json"
                )
    ...
    def _update_model_parameters(self, training_data: dict) -> dict:
        ...
        correct_patterns = [
            f for f in training_data["feedback_history"] if f["feedback"]
        ]
    ...
    def _update_training_timestamp(self):
        ...
        self.memory_engine.memory["learning_metrics"]["last_retrain"] = str(
            datetime.now()
        )
