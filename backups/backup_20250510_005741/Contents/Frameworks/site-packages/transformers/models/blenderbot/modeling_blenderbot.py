...
class BlenderbotEncoder(BlenderbotPreTrainedModel):
    ...
    def __init__(
        self, config: BlenderbotConfig, embed_tokens: Optional[nn.Embedding] = None
    ):
...
class BlenderbotModel(BlenderbotPreTrainedModel):
    ...
    def __init__(self, config: BlenderbotConfig):
        ...
        embed_scale = math.sqrt(config.d_model) if config.scale_embedding else 1.0
        self.shared = BlenderbotScaledWordEmbedding(
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        return super(BlenderbotModel, cls).from_pretrained(
