...
class VideoRenderer:
    def __init__(self):
        ...
        self.banner_path = os.path.join(self.assets_dir, "branding", "Njanja_YouTube_Banner.png")
    ...
    def create_3d_text(self, text, duration, position, fontsize=70, color='white', style_config=None):
    ...
    def create_text_overlay(self, text, duration, position, fontsize=70, color='white', style_config=None):
        ...
        if style_config.get('3d', False):
            return self.create_3d_text(text, duration, position, fontsize, color, style_config)
    ...
    def create_background(self, duration, color=(0, 0, 0), style_config=None):
        ...
        if style_config.get('particles', False):
            return self.create_particle_effect(
                duration,
                num_particles=style_config.get('num_particles', 100)
            )
    ...
    def create_feature_highlight(self, text, start_time, duration, position, style_config=None):
