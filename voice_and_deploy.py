...
class StorefrontDeployer:
    ...
    def generate_voice_over(self) -> Tuple[bool, str]:
        ...
        try:
            ...
            script_path = os.path.join(self.base_dir, "voice_scripts/homepage_intro.txt")
            with open(script_path, 'r') as f:
                text = f.read().strip()
            
            # Generate voice-over
            output_path = os.path.join(self.base_dir, "voice_scripts/homepage_intro.mp3")
        ...
        while time.time() - start_time < timeout:
            try:
                ...
                if os.path.exists(dropbox_package_path):
                    ...
                    local_size = os.path.getsize(os.path.join(os.getcwd(), self.package_name))
    ...
    def deploy(self) -> bool:
        ...
        try:
            ...
            print(f"- Voice-over Duration: {version_info['voice_over']['duration']:.2f} seconds")
