...
class SocialMediaScheduler:
            ...
            post_data = {
                ...
                "specificContent": {
                    "com.linkedin.ugc.ShareContent": {
                        "shareCommentary": {"text": post.get("content", "")},
    ...
    def post_to_twitter(self, post: dict) -> bool:
        ...
        try:
            ...
            # Prepare post data
            post_data = {"text": post.get("content", "")}

            # Make API request
            response = requests.post(
                "https://api.twitter.com/2/tweets", headers=headers, json=post_data
            )
    ...
    def schedule_post(self, platform: str, post: dict, post_time: datetime):
        ...
        try:
            ...
            self.schedule[platform].append({"post": post, "time": post_time})
    ...
    def adjust_to_preferred_time(
        self, post_time: datetime, preferred_times: List[str]
    ) -> datetime:
        """Adjust post time to nearest preferred time."""
        try:
