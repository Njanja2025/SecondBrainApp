...
class FlaxXLMRobertaAttention(nn.Module):
    ...
    def setup(self):
        self.self = FlaxXLMRobertaSelfAttention(
...
class FlaxXLMRobertaLayer(nn.Module):
    ...
    def setup(self):
        self.attention = FlaxXLMRobertaAttention(
        ...
        if self.config.add_cross_attention:
            self.crossattention = FlaxXLMRobertaAttention(
...
class FlaxXLMRobertaLayerCollection(nn.Module):
    ...
    def setup(self):
        if self.gradient_checkpointing:
            FlaxXLMRobertaCheckpointLayer = remat(
                FlaxXLMRobertaLayer, static_argnums=(5, 6, 7)
            )
            self.layers = [
                FlaxXLMRobertaCheckpointLayer(
...
class FlaxXLMRobertaForSequenceClassificationModule(nn.Module):
    ...
    def setup(self):
        ...
        self.classifier = FlaxXLMRobertaClassificationHead(
