from ctypes import c_bool, c_char_p, c_int, c_size_t, Structure, byref, POINTER
...
class PassManager(ffi.ObjectRef):
    ...
    def add_loop_unswitch_pass(
        self, optimize_for_size=False, has_branch_divergence=False
    ):
        """
        ...
        """  # noqa E501
        ffi.lib.LLVMPY_AddLoopUnswitchPass(
            self, optimize_for_size, has_branch_divergence
        )
...
class FunctionPassManager(PassManager):
    ...
    def run(
        self, function, remarks_file=None, remarks_format="yaml", remarks_filter=""
    ):
        """
...
ffi.lib.LLVMPY_AddDotPostDomPrinterPass.argtypes = [ffi.LLVMPassManagerRef, c_bool]
...
ffi.lib.LLVMPY_AddReversePostOrderFunctionAttrsPass.argtypes = [ffi.LLVMPassManagerRef]
...
ffi.lib.LLVMPY_AddLoopUnswitchPass.argtypes = [ffi.LLVMPassManagerRef, c_bool, c_bool]
...
ffi.lib.LLVMPY_AddStripDebugDeclarePrototypesPass.argtypes = [ffi.LLVMPassManagerRef]
...
ffi.lib.LLVMPY_AddTargetLibraryInfoPass.argtypes = [ffi.LLVMPassManagerRef, c_char_p]
ffi.lib.LLVMPY_AddInstructionNamerPass.argtypes = [ffi.LLVMPassManagerRef]

ffi.lib.LLVMPY_AddLegacyRefPrunePass.argtypes = [
    ffi.LLVMPassManagerRef,
    c_int,
    c_size_t,
]
