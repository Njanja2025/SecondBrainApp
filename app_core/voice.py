...
class VoiceAssistant:
    ...
    def _setup(self) -> None:
        ...
        try:
            ...
            self.recognizer.pause_threshold = 0.8  # Shorter pause threshold for more responsive commands
        ...
        with sr.Microphone() as source:
            ...
            while self.is_listening:
                try:
                    ...
                    confidence = self.recognizer.recognize_google(audio, show_all=True).get('confidence', 0.0)
    ...
    def process_command(self, command: str, args: Dict[str, Any] = None, context: Optional[CommandContext] = None) -> Optional[Any]:
            ...
            with zipfile.ZipFile(backup_file, 'w') as zipf:
                ...
                for name, plugin in self.plugins.items():
                    if hasattr(plugin, 'backup'):
                        ...
                        if plugin_data:
                            zipf.writestr(f'plugins/{name}.json', json.dumps(plugin_data, indent=2))
