...
class LiteralStructType(BaseStructType):
    ...
    def __eq__(self, other):
        if isinstance(other, LiteralStructType):
            return self.elements == other.elements and self.packed == other.packed
