...
class TestStencilBase(unittest.TestCase):
    ...
    def _compile_this(self, func, sig, flags):
        return compile_extra(
            registry.cpu_target.typing_context,
...
class TestStencil(TestStencilBase):
    ...
    def test_stencil2(self):
        ...
        def test_seq(n, w, offset):
            ...
            B = numba.stencil(
                stencil2_kernel, neighborhood=((-w, w),), index_offsets=(-offset,)
            )(A, w)
            return B
    ...
    def test_stencil_call(self):
        ...
        def test_impl1(n):
            A = np.arange(n**2).reshape((n, n))
            B = np.zeros(n**2).reshape((n, n))
            numba.stencil(lambda a: 0.25 * (a[0, 1] + a[1, 0] + a[0, -1] + a[-1, 0]))(
                A, out=B
            )
            return B
...
class TestManyStencils(TestStencilBase):
        ...
        * from the njit(parallel=True) of a trivial wrapper function around
        ...
        try:
            if not parfor_ex:
                ...
                try:
                    self.assertIn(
                        "@do_scheduling", wrapped_cpfunc.library.get_llvm_str()
                    )
        ...
        if should_fail:
            ...
            raise RuntimeError(
                (
                    "The following implementations should have "
        ...
        if should_not_fail:
            ...
            str1 = (
                "The following implementations should not have raised an "
                "exception but did:\n%s\n" % impls
            )
            str2 = "Errors were:\n\n%s" % errs
        ...
        def __kernel(a, neighborhood):
            ...
            for __d in range(1, a.shape[3]):
                for __c in range(0, a.shape[2]):
                    for __b in range(0, a.shape[1] - 1):
                        for __a in range(0, a.shape[0]):
                            __b0[__a, __b, __c, __d] = (
                                a[__a + 0, __b + 0, __c + 0, __d + 0]
                                - a[__a + 0, __b + 1, __c + 0, __d + -1]
                                + 1.0
                            )
            return __b0
    ...
    def test_basic29(self):
        ...
        self.check_exceptions(
            kernel, a, expected_exception=[ValueError, NumbaValueError, LoweringError]
        )
    ...
    def test_basic31b(self):
        ...
        a = np.arange(12.0).reshape(3, 4)  # noqa: F841
    ...
    def test_basic38(self):
        ...
        ex = self.exception_dict(
            stencil=NumbaValueError, parfor=NumbaValueError, njit=NumbaValueError
        )
        self.check_exceptions(kernel, a, options={"cval": 1.0j}, expected_exception=ex)
    ...
    def test_basic41(self):
        ...
        self.check_exceptions(
            kernel, a, b, expected_exception=[ValueError, AssertionError]
        )
    ...
    def test_basic44(self):
        ...
        b = np.arange(12.0).reshape(3, 4)
        self.check_exceptions(
            kernel, a, b, expected_exception=[NumbaValueError, LoweringError]
        )
    ...
    def test_basic47(self):
        ...
        def __kernel(a, b, c, neighborhood):
            ...
            for __b in range(0, a.shape[1] - 1):
                for __a in range(1, a.shape[0] - 1):
                    __b0[__a, __b] = (
                        a[__a + 0, __b + 1] + b[__a + 1, __b + 0] + c[__a + -1, __b + 0]
                    )
            return __b0
    ...
    def test_basic49(self):
        ...
        self.check_against_expected(
            kernel, expected, a, b, options={"standard_indexing": "b"}
        )
    ...
    def test_basic52(self):
        ...
        expected = __kernel(a, b, c, None)
        self.check_against_expected(
            kernel, expected, a, b, c, options={"standard_indexing": "b"}
        )
    ...
    def test_basic53(self):
        ...
        b = np.arange(12.0).reshape(3, 4)
        ex = self.exception_dict(
            stencil=Exception, parfor=NumbaValueError, njit=Exception
        )
        self.check_exceptions(
            kernel, a, b, options={"standard_indexing": "c"}, expected_exception=ex
        )
    ...
    def test_basic59(self):
        ...
        expected = __kernel(a, b, c, None)
        self.check_against_expected(
            kernel, expected, a, b, c, options={"standard_indexing": ["b", "c"]}
        )
    ...
    def test_basic62(self):
        ...
        expected = __kernel(a, b, None)
        self.check_against_expected(
            kernel, expected, a, b, options={"standard_indexing": "b", "cval": 10.0}
        )
    ...
    def test_basic63(self):
        ...
        self.check_exceptions(
            kernel, a, b, options={"standard_indexing": "b"}, expected_exception=ex
        )
    ...
    def test_basic77(self):
        ...
        self.check_against_expected(
            kernel, expected, a, b, options={"neighborhood": nh}
        )
    ...
    def test_basic79(self):
        ...
        ex = self.exception_dict(
            stencil=TypingError, parfor=TypingError, njit=TypingError
        )
        self.check_exceptions(
            kernel,
            a,
    ...
    def test_basic81(self):
        ...
        b = a[0].copy()
        ex = self.exception_dict(
            stencil=TypingError, parfor=AssertionError, njit=TypingError
        )
        self.check_exceptions(
            kernel,
            a,
    ...
    def test_basic82(self):
        ...
        self.check_against_expected(
            ...
            a,
            b,
            options={"neighborhood": nh, "standard_indexing": "b"},
        )
    ...
    def test_basic84(self):
        ...
        def __kernel(a, neighborhood):
            ...
            for __b in range(0, a.shape[1] - 1):
                for __a in range(0, a.shape[0]):
                    __b0[__a, __b] = a[__a + 0, __b + 0] + addone_njit.py_func(
                        a[__a + 0, __b + 1]
                    )
            return __b0
    ...
    def test_basic85(self):
        ...
        def __kernel(a, neighborhood):
            ...
            for __b in range(0, a.shape[1] - 1):
                for __a in range(0, a.shape[0]):
                    __b0[__a, __b] = a[__a + 0, __b + 0] + addone_pjit.py_func(
                        a[__a + 0, __b + 1]
                    )
            return __b0
    ...
    def test_basic86(self):
        ...
        a = np.arange(10.0 * 20.0).reshape(10, 20)
        self.check_exceptions(
            kernel, a, options={"bad": 10}, expected_exception=[ValueError, TypingError]
        )
        ...
        def __kernel(a, neighborhood):
            ...
            for __bn in range(1, a.shape[1] - 1):
                for __an in range(1, a.shape[0] - 1):
                    __b0[__an, __bn] = np.median(
                        a[__an + -1 : __an + 2, __bn + -1 : __bn + 2]
                    )
            return __b0
    ...
    def test_basic98(self):
        ...
        for cval in (np.nan, np.inf, -np.inf, float("inf"), -float("inf")):
            ...
            expected = __kernel(a, nh)
            self.check_against_expected(
                kernel, expected, a, options={"neighborhood": nh, "cval": cval}
            )
