...
class ErnieModel(ErniePreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(
        ERNIE_INPUTS_DOCSTRING.format("batch_size, sequence_length")
    )
    @add_code_sample_docstrings(
...
class ErnieForPreTraining(ErniePreTrainedModel):
    ...
    @replace_return_docstrings(
        output_type=ErnieForPreTrainingOutput, config_class=_CONFIG_FOR_DOC
    )
    def forward(
        self,
        input_ids: Optional[torch.Tensor] = None,
...
@add_start_docstrings(
    """Ernie Model with a `language modeling` head on top.""", ERNIE_START_DOCSTRING
)
...
class ErnieForMultipleChoice(ErniePreTrainedModel):
    ...
    @add_start_docstrings_to_model_forward(
        ERNIE_INPUTS_DOCSTRING.format("batch_size, num_choices, sequence_length")
    )
    @add_code_sample_docstrings(
        checkpoint=_CHECKPOINT_FOR_DOC,
