...
div_Tensor = CallFunction(
    aten.div.Tensor, view_default_2, KeywordArg("inv_scale_factor"), _users=2
)
...
view_default_6 = CallFunction(
    aten.view.default, KeywordArg("tangents_1"), Ignored(), _users=2
)
...
div_Tensor_2 = CallFunction(
    aten.div.Tensor, sub_Tensor_1, KeywordArg("inv_scale_factor")
)
...
_sfdp_pattern_3_training = MultiOutputPattern(
    [view_default_5, view_default_9, permute_default_4, view_default_11, None, None]
)
...
view_default_2 = CallFunction(aten.view.default, bmm_default, Ignored())
div_Tensor = CallFunction(
    aten.div.Tensor, view_default_2, KeywordArg("inv_scale_factor")
)
convert_element_type_default = CallFunction(
...
convert_element_type_default_1 = CallFunction(
    prims.convert_element_type.default, div_Tensor_1, Ignored(), _users=2
)
...
convert_element_type_default_5 = CallFunction(
    prims.convert_element_type.default, sub_Tensor_1, Ignored()
)
div_Tensor_2 = CallFunction(
    aten.div.Tensor, convert_element_type_default_5, KeywordArg("inv_scale_factor")
)
view_default_8 = CallFunction(aten.view.default, div_Tensor_2, Ignored(), _users=2)
permute_default_2 = CallFunction(aten.permute.default, view_default_1, Ignored())
bmm_default_3 = CallFunction(aten.bmm.default, view_default_8, permute_default_2)
...
bmm_default_5 = CallFunction(aten.bmm.default, permute_default_5, view_default_6)
view_default_11 = CallFunction(aten.view.default, bmm_default_5, Ignored())
_sfdp_pattern_3_training_half = MultiOutputPattern(
    [view_default_5, view_default_9, permute_default_4, view_default_11, None, None]
)
...
div_Tensor_1 = CallFunction(aten.div.Tensor, exp_default, sum_dim_IntList)
convert_element_type_default_1 = CallFunction(
    prims.convert_element_type.default, div_Tensor_1, Ignored()
)
...
view_default_4 = CallFunction(aten.view.default, expand_default_3, Ignored())
bmm_default_1 = CallFunction(aten.bmm.default, view_default_3, view_default_4)
_sfdp_pattern_3_inference_half = CallFunction(
    aten.view.default, bmm_default_1, Ignored()
)
