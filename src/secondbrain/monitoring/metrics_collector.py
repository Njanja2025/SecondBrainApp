...
class MetricsCollector:
    def __init__(self, enable_prometheus: bool = True, enable_datadog: bool = True):
        ...
        if enable_prometheus:
            ...
            self.blockchain_transactions = Counter('blockchain_transactions_total', 'Total blockchain transactions')
            self.voice_commands = Counter('voice_commands_total', 'Total voice commands processed')
            ...
            # Security metrics
            self.security_incidents = Counter('security_incidents_total', 'Total security incidents')
            self.failed_auth_attempts = Counter('failed_auth_attempts_total', 'Failed authentication attempts')
    ...
    def track_voice_command(self, command_type: str, processing_time: float, success: bool):
