...
class Connection:
    ...
    if sys.version_info >= (3, 11):
        ...
        def create_window_function(
            ...
            aggregate_class: Callable[[], _SingleParamWindowAggregateClass] | None,
            /,
        ) -> None: ...
        ...
        def create_window_function(
            ...
            name: str,
            num_params: Literal[-1],
            aggregate_class: Callable[[], _AnyParamWindowAggregateClass] | None,
            /,
        ) -> None: ...
        @overload
        def create_window_function(
            ...
            name: str,
            num_params: int,
            aggregate_class: Callable[[], _WindowAggregateClass] | None,
            /,
        ) -> None: ...

    def create_collation(
        self, name: str, callback: Callable[[str, str], int | SupportsIndex] | None, /
    ) -> None: ...
    def create_function(
        self,
        name: str,
    ...
    if sys.version_info >= (3, 12):
        def load_extension(
            self, name: str, /, *, entrypoint: str | None = None
        ) -> None: ...
    else:
...
class Cursor(Iterator[Any]):
    ...
    def description(
        self,
    ) -> tuple[tuple[str, None, None, None, None, None, None], ...] | MaybeNone: ...
    @property
    ...
    def setoutputsize(
        self, size: Unused, column: Unused = None, /
    ) -> None: ...  # does nothing
...
if sys.version_info >= (3, 11):
    ...
    class Blob:
        ...
        def __enter__(self) -> Self: ...
        def __exit__(
            self, type: object, val: object, tb: object, /
        ) -> Literal[False]: ...
