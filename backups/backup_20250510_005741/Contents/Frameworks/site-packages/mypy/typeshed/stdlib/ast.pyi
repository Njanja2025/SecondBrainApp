...
_EndPositionT = typing_extensions.TypeVar(
    "_EndPositionT", int, int | None, default=int | None
)
...
class Module(mod):
    ...
    if sys.version_info >= (3, 13):
        def __init__(
            self, body: list[stmt] = ..., type_ignores: list[TypeIgnore] = ...
        ) -> None: ...
    else:
        def __init__(
            self, body: list[stmt], type_ignores: list[TypeIgnore]
...
class FunctionType(mod):
    ...
    if sys.version_info >= (3, 14):
        def __replace__(
            self, *, argtypes: list[expr] = ..., returns: expr = ...
        ) -> Self: ...
...
class Return(stmt):
    ...
    value: expr | None
    def __init__(
        self, value: expr | None = None, **kwargs: Unpack[_Attributes]
    ) -> None: ...

    if sys.version_info >= (3, 14):
        def __replace__(
            self, *, value: expr | None = ..., **kwargs: Unpack[_Attributes]
        ) -> Self: ...
...
class Delete(stmt):
    ...
    if sys.version_info >= (3, 13):
        def __init__(
            self, targets: list[expr] = ..., **kwargs: Unpack[_Attributes]
        ) -> None: ...
    else:
        def __init__(
            self, targets: list[expr], **kwargs: Unpack[_Attributes]
...
class Assert(stmt):
    ...
    msg: expr | None
    def __init__(
        self, test: expr, msg: expr | None = None, **kwargs: Unpack[_Attributes]
    ) -> None: ...

    if sys.version_info >= (3, 14):
        def __replace__(
            self, *, test: expr, msg: expr | None, **kwargs: Unpack[_Attributes]
        ) -> Self: ...
...
class Import(stmt):
    ...
    if sys.version_info >= (3, 13):
        def __init__(
            self, names: list[alias] = ..., **kwargs: Unpack[_Attributes]
        ) -> None: ...
    else:
        def __init__(
            self, names: list[alias], **kwargs: Unpack[_Attributes]
...
class Global(stmt):
    ...
    if sys.version_info >= (3, 13):
        def __init__(
            self, names: list[_Identifier] = ..., **kwargs: Unpack[_Attributes]
        ) -> None: ...
    else:
        def __init__(
            self, names: list[_Identifier], **kwargs: Unpack[_Attributes]
...
class Expr(stmt):
    ...
    if sys.version_info >= (3, 14):
        def __replace__(
            self, *, value: expr = ..., **kwargs: Unpack[_Attributes]
        ) -> Self: ...
...
class BoolOp(expr):
    ...
    if sys.version_info >= (3, 13):
        def __init__(
            self, op: boolop, values: list[expr] = ..., **kwargs: Unpack[_Attributes]
        ) -> None: ...
    else:
        def __init__(
            self, op: boolop, values: list[expr], **kwargs: Unpack[_Attributes]
...
class NamedExpr(expr):
    ...
    value: expr
    def __init__(
        self, target: Name, value: expr, **kwargs: Unpack[_Attributes]
    ) -> None: ...
...
class UnaryOp(expr):
    ...
    operand: expr
    def __init__(
        self, op: unaryop, operand: expr, **kwargs: Unpack[_Attributes]
    ) -> None: ...
...
class Lambda(expr):
    ...
    body: expr
    def __init__(
        self, args: arguments, body: expr, **kwargs: Unpack[_Attributes]
    ) -> None: ...
...
class Set(expr):
    ...
    if sys.version_info >= (3, 13):
        def __init__(
            self, elts: list[expr] = ..., **kwargs: Unpack[_Attributes]
        ) -> None: ...
    else:
...
class JoinedStr(expr):
    ...
    if sys.version_info >= (3, 13):
        def __init__(
            self, values: list[expr] = ..., **kwargs: Unpack[_Attributes]
        ) -> None: ...
    else:
        def __init__(
            self, values: list[expr], **kwargs: Unpack[_Attributes]
...
class Constant(expr):
    ...
    def __init__(
        self, value: Any, kind: str | None = None, **kwargs: Unpack[_Attributes]
    ) -> None: ...
...
class Starred(expr):
    ...
    ctx: expr_context  # Not present in Python < 3.13 if not passed to `__init__`
    def __init__(
        self, value: expr, ctx: expr_context = ..., **kwargs: Unpack[_Attributes]
    ) -> None: ...
...
class ExtSlice(slice):  # deprecated and moved to ast.py if sys.version_info >= (3, 9)
    if sys.version_info >= (3, 9):
        ...
        dims: list[slice]
        def __init__(
            self, dims: list[slice], **kwargs: Unpack[_SliceAttributes]
        ) -> None: ...
...
class AugLoad(
    expr_context
): ...  # deprecated and moved to ast.py if sys.version_info >= (3, 9)
...
class withitem(AST):
    ...
    def __init__(
        self, context_expr: expr, optional_vars: expr | None = None
    ) -> None: ...

    if sys.version_info >= (3, 14):
        def __replace__(
            self, *, context_expr: expr = ..., optional_vars: expr | None = ...
        ) -> Self: ...
...
if sys.version_info >= (3, 10):
    class match_case(AST):
        ...
        if sys.version_info >= (3, 13):
            ...
            @overload
            def __init__(
                self, pattern: _Pattern, guard: expr | None = None, *, body: list[stmt]
            ) -> None: ...
    ...
    class MatchValue(pattern):
        ...
        if sys.version_info >= (3, 14):
            def __replace__(
                self, *, value: expr = ..., **kwargs: Unpack[_Attributes[int]]
            ) -> Self: ...
    ...
    class MatchSequence(pattern):
        ...
        if sys.version_info >= (3, 13):
            def __init__(
                self, patterns: list[pattern] = ..., **kwargs: Unpack[_Attributes[int]]
            ) -> None: ...
        else:
            def __init__(
                self, patterns: list[pattern], **kwargs: Unpack[_Attributes[int]]
    ...
    class MatchStar(pattern):
        ...
        name: _Identifier | None
        def __init__(
            self, name: _Identifier | None, **kwargs: Unpack[_Attributes[int]]
        ) -> None: ...
...
if sys.version_info >= (3, 12):
    ...
    class ParamSpec(type_param):
        ...
        if sys.version_info >= (3, 13):
            ...
            def __init__(
                self, name: _Identifier, **kwargs: Unpack[_Attributes[int]]
            ) -> None: ...
...
if sys.version_info >= (3, 13):
    ...
    def dump(
        node: AST, annotate_fields: bool = True, include_attributes: bool = False
    ) -> str: ...
...
def get_docstring(
    node: AsyncFunctionDef | FunctionDef | ClassDef | Module, clean: bool = True
) -> str | None: ...
def get_source_segment(
    source: str, node: AST, *, padded: bool = False
) -> str | None: ...
def walk(node: AST) -> Iterator[AST]: ...

if sys.version_info >= (3, 14):
    def compare(
        left: AST, right: AST, /, *, compare_attributes: bool = False
    ) -> bool: ...
